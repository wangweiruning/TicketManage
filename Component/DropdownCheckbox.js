    ...
    render(){
        ...
        return(
            ...
            <View style={{flexDirection:'row',alignItems:'center',...this.props.style}}>
                        <Text style={{backgroundColor:this.props.isshow?'rgba(0,0,0,.2)':"wihte",padding:5,flex:1,flexDirection:'row',color:color?color:'black',fontSize:fontSize?fontSize:18}}>{
                           this.open()
                        }</Text>
                    </View>
            </TouchableOpacity>
