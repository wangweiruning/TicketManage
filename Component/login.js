...
async submitgo(data){
    ...
    render(){
        ...
        <View style={{alignItems:'center'}}>
           ...
           <InputItem type="password" defaultValue={this.state.pass} placeholder="密码" onChange={(v)=>this.handleInput('pass',v)} style={{borderRadius:5,backgroundColor:'white',width:'85%',top:10}}/>
