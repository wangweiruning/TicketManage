...
console.log(gettrues,"llllllllllllllllllllll")
    ...
    render() {
        const templateContents = this.state.templateContents;
        return (<View style={{ justifyContent: 'center' }}>
            ...
            {this.state.mengCard && <View
                style={{
                    display: "flex", flexDirection: "column", zIndex: 444,
            ...
            <ScrollView style={{ display: 'flex' }}>
                <View style={{ marginBottom: 20 }}>
                    {
                        templateContents.length>0&&templateContents.map((v, i) => {
                            ...
                            return <View key={i} style={{ marginTop: 5, padding: 5, alignItems: 'center', width: '100%' }}>
                                <View style={{
                                    ...
                                    <Text style={{ width: '90%',color: '#3f4044', left: 2 }}>{v.ParaName}</Text>
