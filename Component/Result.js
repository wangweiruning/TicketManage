                    ...
                    <ScrollView >
                                            ...
                                            <View>
                                                {v.IsConfirm == 1 ? <View style={{ flexDirection: 'column',width:'100%'}}>
                                                    <TextInput
                                                        ...
                                                        style={{minWidth:'98%',maxWidth:'98.1%',backgroundColor:dis?"rgba(255,255,255,.2)":"rgba(255,255,255,.4)",color:'white'}} />
                        ...
                        {this.props.navigation.state.params.isqianfa&&!this.state.mengCard&&<View>
                            ...
                            <View style={{width:'96%',borderBottomColor:'rgba(255,255,255,.2)',borderBottomWidth:1,borderStyle:'solid',padding:6}}>
                                ...
                                style={{paddingVertical: 5,minWidth:'98%',backgroundColor:"rgba(255,255,255,.2)",color:'white'}}/>
                            </View>
                            </View>
                            </View> 
